...
const UpdateRequestScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleSubmitRequest = () => {
    ...
    const message = `Update Request:\nItem: ${selectedItem?.name}\nCustomer: ${userMobile}\n\nChanges Requested:\n• Brand: ${updateForm.brand}\n• Item Count: ${updateForm.itemCount}\n• Address: ${updateForm.address}\n${updateForm.alternateAddress ? `• Alternate Address: ${updateForm.alternateAddress}\n` : ''}${updateForm.specialInstructions ? `• Special Instructions: ${updateForm.specialInstructions}` : ''}`;
